...
PAGES: list[tuple[str, str, str]] = [
    ...
    ("spire", "Spire: an infrastructure project", "INDEPENDENT PROJECT / ALTHOR LABS"),
    ("checklist", "Agent Security Review Checklist", "FIELD GUIDE / FREE PDF"),
]

BASE_CARDS: list[tuple[str, str, str]] = [
    ("og-default.png", "AI systems & workflow automation.", "ALTHOR LABS"),
    ("og-essay.png", "Technical notes", "ALTHOR LABS"),
    ("og-case-study.png", "Selected work", "ALTHOR LABS"),
]
